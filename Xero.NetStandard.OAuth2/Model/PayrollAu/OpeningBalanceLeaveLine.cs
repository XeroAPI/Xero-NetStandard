...
namespace Xero.NetStandard.OAuth2.Model.PayrollAu
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpeningBalanceLeaveLine :  IEquatable<OpeningBalanceLeaveLine>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OpeningBalanceLeaveLine);
        }

        /// <summary>
        /// Returns true if OpeningBalanceLeaveLine instances are equal
        /// </summary>
        /// <param name="input">Instance of OpeningBalanceLeaveLine to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpeningBalanceLeaveLine input)
        {
            if (input == null)
                return false;
