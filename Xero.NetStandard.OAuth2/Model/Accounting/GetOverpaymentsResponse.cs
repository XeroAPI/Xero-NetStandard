...
namespace Xero.NetStandard.OAuth2.Model.Accounting
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetOverpaymentsResponse :  IEquatable<GetOverpaymentsResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets Overpayments
        /// </summary>
        [DataMember(Name="Overpayments", EmitDefaultValue=false)]
        public List<Overpayments> Overpayments { get; set; }
        ...
        {
            return this.Equals(input as GetOverpaymentsResponse);
        }

        /// <summary>
        /// Returns true if GetOverpaymentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetOverpaymentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOverpaymentsResponse input)
        {
            if (input == null)
                return false;
