...
namespace Xero.NetStandard.OAuth2.Model.Accounting
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPrepaymentsResponse :  IEquatable<GetPrepaymentsResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetPrepaymentsResponse);
        }

        /// <summary>
        /// Returns true if GetPrepaymentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPrepaymentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPrepaymentsResponse input)
        {
            if (input == null)
                return false;
