...
namespace Xero.NetStandard.OAuth2.Model.Accounting
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPaymentsResponse :  IEquatable<GetPaymentsResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetPaymentsResponse);
        }

        /// <summary>
        /// Returns true if GetPaymentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPaymentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPaymentsResponse input)
        {
            if (input == null)
                return false;
