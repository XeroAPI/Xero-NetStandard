...
namespace Xero.NetStandard.OAuth2.Model.Accounting
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrackingReference :  IEquatable<TrackingReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingReference" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TrackingReference);
        }

        /// <summary>
        /// Returns true if TrackingReference instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackingReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackingReference input)
        {
            if (input == null)
                return false;
