...
namespace Xero.NetStandard.OAuth2.Model.Accounting
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetBankTransactionsResponse :  IEquatable<GetBankTransactionsResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetBankTransactionsResponse);
        }

        /// <summary>
        /// Returns true if GetBankTransactionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBankTransactionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBankTransactionsResponse input)
        {
            if (input == null)
                return false;
