...
namespace Xero.NetStandard.OAuth2.Model.Accounting
{
    ...
    public partial class GetContactsResponse :  IEquatable<GetContactsResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetContactsResponse);
        }

        /// <summary>
        /// Returns true if GetContactsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetContactsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetContactsResponse input)
        {
            if (input == null)
                return false;
