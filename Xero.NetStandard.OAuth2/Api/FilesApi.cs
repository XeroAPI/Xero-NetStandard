...
namespace Xero.NetStandard.OAuth2.Api
{
    ...
    public interface IFilesApiAsync : IApiAccessor
    {
        ...
        /// <param name="page">number of records to skip for pagination (optional)</param>
        /// <param name="sort">values to sort by (optional)</param>
        /// <param name="direction">sort direction (optional)</param>
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of Files</returns>
        System.Threading.Tasks.Task<Files> GetFilesAsync (string accessToken, string xeroTenantId, int? pagesize = null, int? page = null, string sort = null, string direction = null, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<Files>> GetFilesAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? pagesize = null, int? page = null, string sort = null, string direction = null, CancellationToken cancellationToken = default);
        /// <summary>
    ...
    public partial class FilesApi : IFilesApi
    {
        ...
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Association>> CreateFileAssociationAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid fileId, Association association, string idempotencyKey = null, CancellationToken cancellationToken = default)
        {
            ...
            if (association == null)
                throw new Xero.NetStandard.OAuth2.Client.ApiException(400, "Missing required parameter 'association' when calling FilesApi->CreateFileAssociation");
        ...
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Folder>> CreateFolderAsyncWithHttpInfo (string accessToken, string xeroTenantId, Folder folder, string idempotencyKey = null, CancellationToken cancellationToken = default)
        {
            ...
            if (folder == null)
                throw new Xero.NetStandard.OAuth2.Client.ApiException(400, "Missing required parameter 'folder' when calling FilesApi->CreateFolder");
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of Files</returns>
        public async System.Threading.Tasks.Task<Files> GetFilesAsync (string accessToken, string xeroTenantId, int? pagesize = null, int? page = null, string sort = null, string direction = null, CancellationToken cancellationToken = default)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Files> localVarResponse = await GetFilesAsyncWithHttpInfo(accessToken, xeroTenantId, pagesize, page, sort, direction, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (Files)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Files>> GetFilesAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? pagesize = null, int? page = null, string sort = null, string direction = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<FileObject>> UpdateFileAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid fileId, FileObject fileObject, string idempotencyKey = null, CancellationToken cancellationToken = default)
        {
            ...
            if (fileObject == null)
                throw new Xero.NetStandard.OAuth2.Client.ApiException(400, "Missing required parameter 'fileObject' when calling FilesApi->UpdateFile");
