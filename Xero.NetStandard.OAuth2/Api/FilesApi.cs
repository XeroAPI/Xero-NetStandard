...
namespace Xero.NetStandard.OAuth2.Api
{
    ...
    public interface IFilesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Association> CreateFileAssociationAsync (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, Association association = null, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<Association>> CreateFileAssociationAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, Association association = null, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Folder> CreateFolderAsync (string accessToken, string xeroTenantId, string idempotencyKey = null, Folder folder = null, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<Folder>> CreateFolderAsyncWithHttpInfo (string accessToken, string xeroTenantId, string idempotencyKey = null, Folder folder = null, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of FileObject</returns>
        System.Threading.Tasks.Task<FileObject> UpdateFileAsync (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, FileObject fileObject = null, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (FileObject)</returns>
        System.Threading.Tasks.Task<ApiResponse<FileObject>> UpdateFileAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, FileObject fileObject = null, CancellationToken cancellationToken = default);
        /// <summary>
    ...
    public partial class FilesApi : IFilesApi
    {
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of Association</returns>
        public async System.Threading.Tasks.Task<Association> CreateFileAssociationAsync (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, Association association = null, CancellationToken cancellationToken = default)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Association> localVarResponse = await CreateFileAssociationAsyncWithHttpInfo(accessToken, xeroTenantId, fileId, idempotencyKey, association, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (Association)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Association>> CreateFileAssociationAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, Association association = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of Folder</returns>
        public async System.Threading.Tasks.Task<Folder> CreateFolderAsync (string accessToken, string xeroTenantId, string idempotencyKey = null, Folder folder = null, CancellationToken cancellationToken = default)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Folder> localVarResponse = await CreateFolderAsyncWithHttpInfo(accessToken, xeroTenantId, idempotencyKey, folder, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (Folder)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Folder>> CreateFolderAsyncWithHttpInfo (string accessToken, string xeroTenantId, string idempotencyKey = null, Folder folder = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<List<Association>>> GetAssociationsByObjectAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid objectId, int? pagesize = null, int? page = null, string sort = null, string direction = null, CancellationToken cancellationToken = default)
        {
            ...
            if (direction != null)
            {
                foreach (var kvp in Xero.NetStandard.OAuth2.Client.ClientUtils.ParameterToMultiMap("", "direction", direction))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Object>> GetAssociationsCountAsyncWithHttpInfo (string accessToken, string xeroTenantId, List<Guid> objectIds, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
                throw new Xero.NetStandard.OAuth2.Client.ApiException(400, "Missing required parameter 'xeroTenantId' when calling FilesApi->GetAssociationsCount");

            // verify the required parameter 'objectIds' is set
            if (objectIds == null)
                throw new Xero.NetStandard.OAuth2.Client.ApiException(400, "Missing required parameter 'objectIds' when calling FilesApi->GetAssociationsCount");
            ...
            if (objectIds != null)
            {
                foreach (var kvp in Xero.NetStandard.OAuth2.Client.ClientUtils.ParameterToMultiMap("multi", "ObjectIds", objectIds))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of FileObject</returns>
        public async System.Threading.Tasks.Task<FileObject> UpdateFileAsync (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, FileObject fileObject = null, CancellationToken cancellationToken = default)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<FileObject> localVarResponse = await UpdateFileAsyncWithHttpInfo(accessToken, xeroTenantId, fileId, idempotencyKey, fileObject, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (FileObject)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<FileObject>> UpdateFileAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid fileId, string idempotencyKey = null, FileObject fileObject = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
