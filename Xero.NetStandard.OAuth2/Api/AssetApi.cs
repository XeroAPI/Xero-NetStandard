...
namespace Xero.NetStandard.OAuth2.Api
{
    ...
    public partial class AssetApi : IAssetApi
    {
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Asset> localVarResponse = await CreateAssetAsyncWithHttpInfo(accessToken, xeroTenantId, asset, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (Asset)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Asset>> CreateAssetAsyncWithHttpInfo (string accessToken, string xeroTenantId, Asset asset, CancellationToken cancellationToken = default)
        {
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<AssetType> localVarResponse = await CreateAssetTypeAsyncWithHttpInfo(accessToken, xeroTenantId, assetType, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (AssetType)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<AssetType>> CreateAssetTypeAsyncWithHttpInfo (string accessToken, string xeroTenantId, AssetType assetType = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
