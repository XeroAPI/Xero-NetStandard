...
namespace Xero.NetStandard.OAuth2.Api
{
    ...
    public interface IAppStoreApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<UsageRecordsList> GetUsageRecordsAsync (string accessToken, Guid subscriptionId);
        ...
        System.Threading.Tasks.Task<ApiResponse<UsageRecordsList>> GetUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId);
        /// <summary>
        ...
        System.Threading.Tasks.Task<UsageRecord> PostUsageRecordsAsync (string accessToken, Guid subscriptionId, Guid subscriptionItemId, CreateUsageRecord createUsageRecord);
        ...
        System.Threading.Tasks.Task<ApiResponse<UsageRecord>> PostUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId, Guid subscriptionItemId, CreateUsageRecord createUsageRecord);
        /// <summary>
        ...
        /// <returns>Task of UsageRecord</returns>
        System.Threading.Tasks.Task<UsageRecord> PutUsageRecordsAsync (string accessToken, Guid subscriptionId, Guid subscriptionItemId, Guid usageRecordId, UpdateUsageRecord updateUsageRecord);
        ...
        /// <param name="updateUsageRecord">Contains the quantity for the usage record to update</param>
        /// <returns>Task of ApiResponse (UsageRecord)</returns>
        System.Threading.Tasks.Task<ApiResponse<UsageRecord>> PutUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId, Guid subscriptionItemId, Guid usageRecordId, UpdateUsageRecord updateUsageRecord);
    ...
    public partial class AppStoreApi : IAppStoreApi
    {
        ...
        /// <param name="subscriptionId">Unique identifier for Subscription object</param>
        /// <returns>Task of UsageRecordsList</returns>
        public async System.Threading.Tasks.Task<UsageRecordsList> GetUsageRecordsAsync (string accessToken, Guid subscriptionId)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<UsageRecordsList> localVarResponse = await GetUsageRecordsAsyncWithHttpInfo(accessToken, subscriptionId);
             return localVarResponse.Data;
        ...
        /// <param name="subscriptionId">Unique identifier for Subscription object</param>
        /// <returns>Task of ApiResponse (UsageRecordsList)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<UsageRecordsList>> GetUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId)
        {
            // verify the required parameter 'subscriptionId' is set
            if (subscriptionId == null)
            ...
            var response = await this.AsynchronousClient.GetAsync<UsageRecordsList>("/subscriptions/{subscriptionId}/usage-records", requestOptions, this.Configuration);
        ...
        /// <param name="createUsageRecord">Contains the quantity for the usage record to create</param>
        /// <returns>Task of UsageRecord</returns>
        public async System.Threading.Tasks.Task<UsageRecord> PostUsageRecordsAsync (string accessToken, Guid subscriptionId, Guid subscriptionItemId, CreateUsageRecord createUsageRecord)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<UsageRecord> localVarResponse = await PostUsageRecordsAsyncWithHttpInfo(accessToken, subscriptionId, subscriptionItemId, createUsageRecord);
             return localVarResponse.Data;
        ...
        /// <param name="createUsageRecord">Contains the quantity for the usage record to create</param>
        /// <returns>Task of ApiResponse (UsageRecord)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<UsageRecord>> PostUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId, Guid subscriptionItemId, CreateUsageRecord createUsageRecord)
        {
            // verify the required parameter 'subscriptionId' is set
            if (subscriptionId == null)
            ...
            var response = await this.AsynchronousClient.PostAsync<UsageRecord>("/subscriptions/{subscriptionId}/items/{subscriptionItemId}/usage-records", requestOptions, this.Configuration);
        ...
        /// <param name="updateUsageRecord">Contains the quantity for the usage record to update</param>
        /// <returns>Task of UsageRecord</returns>
        public async System.Threading.Tasks.Task<UsageRecord> PutUsageRecordsAsync (string accessToken, Guid subscriptionId, Guid subscriptionItemId, Guid usageRecordId, UpdateUsageRecord updateUsageRecord)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<UsageRecord> localVarResponse = await PutUsageRecordsAsyncWithHttpInfo(accessToken, subscriptionId, subscriptionItemId, usageRecordId, updateUsageRecord);
             return localVarResponse.Data;
        ...
        /// <param name="updateUsageRecord">Contains the quantity for the usage record to update</param>
        /// <returns>Task of ApiResponse (UsageRecord)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<UsageRecord>> PutUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId, Guid subscriptionItemId, Guid usageRecordId, UpdateUsageRecord updateUsageRecord)
        {
            // verify the required parameter 'subscriptionId' is set
            if (subscriptionId == null)
            ...
            var response = await this.AsynchronousClient.PutAsync<UsageRecord>("/subscriptions/{subscriptionId}/items/{subscriptionItemId}/usage-records/{usageRecordId}", requestOptions, this.Configuration);
