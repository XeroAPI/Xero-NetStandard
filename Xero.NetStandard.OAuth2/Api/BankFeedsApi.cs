...
namespace Xero.NetStandard.OAuth2.Api
{
    ...
    public partial class BankFeedsApi : IBankFeedsApi
    {
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<FeedConnections> localVarResponse = await CreateFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, feedConnections, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (FeedConnections)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<FeedConnections>> CreateFeedConnectionsAsyncWithHttpInfo (string accessToken, string xeroTenantId, FeedConnections feedConnections, CancellationToken cancellationToken = default)
        {
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Statements> localVarResponse = await CreateStatementsAsyncWithHttpInfo(accessToken, xeroTenantId, statements, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (Statements)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Statements>> CreateStatementsAsyncWithHttpInfo (string accessToken, string xeroTenantId, Statements statements = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<FeedConnections> localVarResponse = await DeleteFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, feedConnections, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (FeedConnections)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<FeedConnections>> DeleteFeedConnectionsAsyncWithHttpInfo (string accessToken, string xeroTenantId, FeedConnections feedConnections, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<FeedConnection> localVarResponse = await GetFeedConnectionAsyncWithHttpInfo(accessToken, xeroTenantId, id, cancellationToken);
             return localVarResponse.Data;
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<FeedConnections> localVarResponse = await GetFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, page, pageSize, cancellationToken);
             return localVarResponse.Data;
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Statement> localVarResponse = await GetStatementAsyncWithHttpInfo(accessToken, xeroTenantId, statementId, cancellationToken);
             return localVarResponse.Data;
        ...
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Statements> localVarResponse = await GetStatementsAsyncWithHttpInfo(accessToken, xeroTenantId, page, pageSize, xeroApplicationId, xeroUserId, cancellationToken);
             return localVarResponse.Data;
