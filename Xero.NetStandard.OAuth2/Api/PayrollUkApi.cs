...
namespace Xero.NetStandard.OAuth2.Api
{
    ...
    public interface IPayrollUkApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Timesheets> GetTimesheetsAsync (string accessToken, string xeroTenantId, int? page = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Timesheets>> GetTimesheetsAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? page = null, string filter = null);
        /// <summary>
    ...
    public partial class PayrollUkApi : IPayrollUkApi
    {
        ...
        /// <param name="filter">Filter by first name and/or lastname (optional)</param>
        /// <returns>Task of Timesheets</returns>
        public async System.Threading.Tasks.Task<Timesheets> GetTimesheetsAsync (string accessToken, string xeroTenantId, int? page = null, string filter = null)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<Timesheets> localVarResponse = await GetTimesheetsAsyncWithHttpInfo(accessToken, xeroTenantId, page, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Filter by first name and/or lastname (optional)</param>
        /// <returns>Task of ApiResponse (Timesheets)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<Timesheets>> GetTimesheetsAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? page = null, string filter = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
