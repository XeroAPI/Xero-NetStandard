...
namespace Xero.NetStandard.OAuth2.Api
{
    ...
    public interface IIdentityApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Connection>> GetConnectionsAsync (string accessToken);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Connection>>> GetConnectionsAsyncWithHttpInfo (string accessToken);
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        /// <exception cref="Xero.NetStandard.OAuth2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;Connection&gt;</returns>
        public async System.Threading.Tasks.Task<List<Connection>> GetConnectionsAsync (string accessToken)
        {
             Xero.NetStandard.OAuth2.Client.ApiResponse<List<Connection>> localVarResponse = await GetConnectionsAsyncWithHttpInfo(accessToken);
        ...
        /// <exception cref="Xero.NetStandard.OAuth2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;Connection&gt;)</returns>
        public async System.Threading.Tasks.Task<Xero.NetStandard.OAuth2.Client.ApiResponse<List<Connection>>> GetConnectionsAsyncWithHttpInfo (string accessToken)
        {
