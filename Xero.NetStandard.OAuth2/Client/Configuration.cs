...
namespace Xero.NetStandard.OAuth2.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            switch (status)
            {
                case int code when status == 400:
                    var error = JsonConvert.DeserializeObject<Error>(response.Content.ToString());
                    var validationBuilder = new StringBuilder();
                    var delimiter = "";
                    foreach (Element e in error.Elements)
                    {
                        foreach (ValidationError v in e.ValidationErrors)
                        {
                            validationBuilder.Append(delimiter);
                            validationBuilder.Append(v.Message);
                            delimiter = ",";
                        }
        ...
        {
            UserAgent = "xero-netstandard-0.4.4";
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 0.4.4\n";
