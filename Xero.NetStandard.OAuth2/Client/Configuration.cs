...
namespace Xero.NetStandard.OAuth2.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "xero-netstandard-3.29.2";
            BasePath = "https://api.xero.com/projects.xro/2.0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.xero.com/projects.xro/2.0") : this()
        {
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.31.1\n";
            report += "    SDK Package Version: 3.29.2\n";
