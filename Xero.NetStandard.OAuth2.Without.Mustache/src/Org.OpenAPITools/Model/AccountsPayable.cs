...
namespace Org.OpenAPITools.Model
{
    ...
    /// AccountsPayable
    /// </summary>
    [DataContract(Name = "AccountsPayable")]
    public partial class AccountsPayable : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsPayable" /> class.
        /// </summary>
        /// <param name="outstanding">outstanding.</param>
        /// <param name="overdue">overdue.</param>
        public AccountsPayable(double outstanding = default(double), double overdue = default(double))
        {
