...
namespace Xero.NetStandard.OAuth2.Test.Model.PayrollNz
{
    ...
    public class AccountTests : IDisposable
    {
        ...
        public async Task TypeEnum_ValidInput_Deserialises(string input, Account.TypeEnum expected)
        {
            ...
            var actual = await deserializer.Deserialize<Account.TypeEnum>(response);
